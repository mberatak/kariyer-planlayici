    ...
    options: [
      {
        ...
        weights: { 'web-dev': 3, 'mobile': 2, 'game-dev': 2, 'ai-ml': -2 },
      },
      {
        label: 'B',
        text: 'Sistemi kafamda tasarlamak, altyapıyı planlamak',
        weights: { 'devops': 2, 'software-architecture': 3, 'embedded': 1 },
      },
      {
        label: 'C',
        text: 'Veriyi analiz edip içgörüler çıkarmak',
        weights: { 'data-science': 3, 'ai-ml': 3, 'data-engineering': 2 },
      },
      {
        label: 'D',
        text: 'Doğrudan kodu açıp denemelere başlamak',
        weights: { 'cybersecurity': 3, 'qa-testing': 2, 'web-dev': 1 },
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        weights: { 'product': 4, 'web-dev': 2, 'game-dev': 1 },
      },
      {
        label: 'B',
        text: 'Derin, bireysel çalışma odaklanma zamanı',
        weights: { 'ai-ml': 2, 'cybersecurity': 3, 'embedded': 3 },
      },
      {
        label: 'C',
        text: 'Küçük teknik ekip, net hedefler',
        weights: { 'devops': 3, 'data-engineering': 3, 'software-architecture': 3 },
      },
      {
        label: 'D',
        text: 'Kullanıcıyla yakın iletişim kurarak',
        weights: { 'product': 4, 'qa-testing': 3 },
      },
    ],
  },
  {
